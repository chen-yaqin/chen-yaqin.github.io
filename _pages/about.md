...
My research interests broadly encompass **statistics and its applications in generative models**. I am particularly intrigued by the mathematical foundations of machine learning and its intersection with probabilistic modeling. You can find more details about my work in my [publications](https://github.com/chen-yaqin/chen-yaqin.github.io/publications) or [CV (PDF)](https://github.com/chen-yaqin/chen-yaqin.github.io/cv). I am also open to exploring new topics, so feel free to reach out if you'd like to discuss potential collaborations.
